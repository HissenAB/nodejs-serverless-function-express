...
// Enkel CORS-hantering
export default async function handler(req, res) {
  res.setHeader("Access-Control-Allow-Origin", "https://hisseninstruktionsfilmer.github.io");
